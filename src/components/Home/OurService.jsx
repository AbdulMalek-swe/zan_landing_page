    ...
    return (
        <div>
            <div className='py-10'><div className='grid justify-center'><p className='text-center text-lg text-red-400 border border-red-300 rounded-lg bg-green-200 font-semibold px-2'>Our Services</p></div>
                <h1 className='text-center text-5xl font-bold '>Comprehensive Plan</h1></div>
            <div className='grid grid-cols-3 gap-5'>
                <div className='border p-4  rounded-lg bg-slate-100'>
                    ...
                    <h1 className='text-center font-bold m-4 text-2xl'>Fuel Delivery</h1>
                ...
                <div className='border p-4 rounded-lg bg-slate-100'>
                    ...
                    <h1 className='text-center font-bold m-4 text-2xl'>Fuel Storage Solutions</h1>
                ...
                <div className='border p-4  rounded-lg bg-slate-100'>
                    ...
                    <h1 className='text-center font-bold m-4 text-2xl'>Equipment Maintenanceegies</h1>
