...
const pathName = usePathname();
  ...
  return (
    <div className={`top-0 fixed w-full z-10 ${shadow ? "shadow-md backdrop-blur-lg" : " bg-[#FEF6F3]"}`}>
      ...
      <span className="relative text-black text-base font-bold">Contact</span>
    </Link>

        </div>
        <button  onClick={() => toggleDrawer()} className=" cursor-pointer md:hidden" aria-labelledby="labeldiv">
          <GiHamburgerMenu />
        </button>
      </nav>
